...
class TestLoad(unittest.TestCase):
    ...
    def test_load(self):
        data = [{'accountid':'1', 'gender':'female', 'age':42, 'country':'Germany', 
                 'extract_date':'2018-06-28', 'load_date':'2019-03-07'},
                {'accountid':'2', 'gender':'male', 'age':38, 'country':'United States', 
                 'extract_date':'2018-06-28', 'load_date':'2019-03-07'}]
        Load.load(data, 'test', TEST_DB)

        expected = [('1', 'female', 42, 'Germany', '2018-06-28', '2019-03-07'), 
                    ('2', 'male', 38, 'United States', '2018-06-28', '2019-03-07')]
        with sqlite3.connect(TEST_DB) as conn:
            c = conn.cursor()
    ...
    def test_load_replace(self):
        ...
        expected = [('1', 'female', 42, 'Germany', '2018-06-28', '2019-03-07'), 
                    ('2', 'FEMALE', 38, 'United States', '2018-06-28', '2019-03-07')]
        with sqlite3.connect(TEST_DB) as conn:
            c = conn.cursor()
            sql = '''SELECT * FROM test_accounts'''
            c.execute(sql)
